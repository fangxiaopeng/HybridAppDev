...
public class FileUtils extends CordovaPlugin {
    ...
    public static final int DIRECTORY_READ_PERM = 0;
    public static final int FILE_READ_PERM = 1;
    public static final int WRITE_PERM = 2;
    ...
    private void getReadPermission(boolean isDirectory) {
        if (isDirectory) {
            PermissionHelper.requestPermission(this, DIRECTORY_READ_PERM, permissions[0]);
        } else {
            PermissionHelper.requestPermission(this, FILE_READ_PERM, permissions[0]);
        }
    }

    private void getWritePermission() {
        PermissionHelper.requestPermission(this, WRITE_PERM, permissions[1]);
    }


    private boolean hasReadPermission() {
        return PermissionHelper.hasPermission(this, permissions[0]);
    }

    private boolean hasWritePermission() {
        return PermissionHelper.hasPermission(this, permissions[1]);
    }
